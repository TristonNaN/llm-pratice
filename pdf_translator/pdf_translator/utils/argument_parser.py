...
class ArgumentParser:
    ...
    def parse_arguments(self):
        ...
        self.parser.add_argument('--openai_api_key', type=str, default=config['OpenAIModel']['api_key'],
                                 help='The API key for OpenAIModel. Required if model_type is "OpenAIModel".')
        self.parser.add_argument('--file_path', type=str, default=config['common']['file_path'],
